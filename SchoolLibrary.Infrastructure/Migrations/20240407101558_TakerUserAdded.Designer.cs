...
namespace SchoolLibrary.Infrastructure.Migrations
{
    ...
    [Migration("20240407101558_TakerUserAdded")]
    partial class TakerUserAdded
    {
            ...
            modelBuilder.Entity("SchoolLibrary.Infrastructure.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8af160da-8fe8-4090-9ce4-20af431bea10",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEA6jqBC4g2bXlqb6WjhYAek0+whbl/ZL4vwzWboVnZCtdRHamN2NHD3brb9m5dL5ZQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "d93a14a8-31aa-4c96-b0b1-6ae0f8abf5e9",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "443c82e9-82ad-4f45-ae12-cb3cf64b7033",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEFHNcaaT0X4cwfDpmHTo1WXM8ZPMImHk7tDC6iuzqQtyTrNxkJGZf1lHEfn3rJaSgw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "b84321be-0afb-43cc-a418-5362dce22f10",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9cb6e32c-724c-447e-a11e-9a39bf3f73ff",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEIDxgDc6U8CcFI81mUhm0YbztFEcoafBa88/INw0lPWyUUu1CP4nCtLjxbtDdVsRlg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "24a2c5b1-1587-4083-aab6-85afa9702d1d",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("SchoolLibrary.Infrastructure.Data.Models.Author", b =>
                {
                    b.HasOne("SchoolLibrary.Infrastructure.Data.Models.ApplicationUser", "User")
                        .WithOne("Author")
                        .HasForeignKey("SchoolLibrary.Infrastructure.Data.Models.Author", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SchoolLibrary.Infrastructure.Data.Models.Book", b =>
                {
                    ...
                    b.HasOne("SchoolLibrary.Infrastructure.Data.Models.ApplicationUser", "Taker")
                        .WithMany()
